...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-gray-200 bg-white text-gray-900 shadow-sm transition-all duration-200 hover:shadow-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100",
      className
    )}
    {...props}
  />
